...
2. Change directory to demo repository and terraform directory.
   ...
   ```
   cd workshop-mortgage-underwriting-agentic-system/self-serve/terraform
   ```
3. Configure AWS CLI
...
2. Change directory to `data-gen` directory:
   ```
   cd self-serve/terraform/data-gen
   ```
3. Run ShadowTraffic
...
Before tearing down the infrastructure, delete the Oracle XStream connector, as it was created outside of Terraform and won't be automatically removed:
