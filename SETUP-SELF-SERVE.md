...
To destroy all the resources created (including the Postgres CDC connector, data generator, and webapp containers) run the command below from the ```terraform/self-serve``` directory:
